...
while True: 
	...
	# Note that the "old" way of doing this is done if this program is being run by python2, and the new way is used if python3 is responsible for running this program.
